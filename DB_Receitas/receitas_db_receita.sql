...
CREATE TABLE `receita` (
  ...
  CONSTRAINT `fk_receita_categoria` FOREIGN KEY (`categoria_id`) REFERENCES `categoria` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
...
-- Dump completed on 2025-09-11 13:15:16
